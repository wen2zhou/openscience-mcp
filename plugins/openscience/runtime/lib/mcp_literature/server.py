...
# Structured missing-key result (mirrors variants' contact_email_required):
# reaches the agent as a clean tool result it can act on — never a server
# crash, never an anonymous retry.
